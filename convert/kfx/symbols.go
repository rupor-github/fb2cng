...
const (
	...
	SymMinWidth                KFXSymbol = 63  // min_width
	SymMaxHeight               KFXSymbol = 64  // max_height
	SymMaxWidth                KFXSymbol = 65  // max_width
	...
	SymBorderSpacingVertical   KFXSymbol = 456 // border_spacing_vertical
	SymBorderSpacingHorizontal KFXSymbol = 457 // border_spacing_horizontal
	SymHideEmptyCells          KFXSymbol = 458 // hide_empty_cells
	...
	// Writing mode and vertical text ($557-$560, $706-$707)
	SymHorizontalTb    KFXSymbol = 557 // horizontal_tb
	SymVerticalLr      KFXSymbol = 558 // vertical_lr
	SymVerticalRl      KFXSymbol = 559 // vertical_rl
	...
	SymTextEmphasisColor              KFXSymbol = 718 // text_emphasis_color
	SymTextEmphasisPositionHorizontal KFXSymbol = 719 // text_emphasis_position_horizontal
	SymTextEmphasisPositionVertical   KFXSymbol = 720 // text_emphasis_position_vertical
	SymFilled                         KFXSymbol = 724 // filled
	SymOpen                           KFXSymbol = 725 // open
	SymFilledDot                      KFXSymbol = 726 // filled_dot
	SymOpenDot                        KFXSymbol = 727 // open_dot
	SymFilledCircle                   KFXSymbol = 728 // filled_circle
	SymOpenCircle                     KFXSymbol = 729 // open_circle
	SymFilledDoubleCircle             KFXSymbol = 730 // filled_double_circle
	SymOpenDoubleCircle               KFXSymbol = 731 // open_double_circle
	SymFilledTriangle                 KFXSymbol = 732 // filled_triangle
	SymOpenTriangle                   KFXSymbol = 733 // open_triangle
	SymFilledSesame                   KFXSymbol = 734 // filled_sesame
	SymOpenSesame                     KFXSymbol = 735 // open_sesame
	SymSideways                       KFXSymbol = 778 // sideways
	SymUpright                        KFXSymbol = 779 // upright
	SymKeepLinesTogether              KFXSymbol = 785 // keep_lines_together
)
